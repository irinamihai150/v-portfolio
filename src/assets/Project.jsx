...
function Project() {
	return (
		<div>
			{/* Projects section */}
			<section id='projects'>
				<h2 className='text-5xl text-center mb-4'>MY PROJECTS</h2>
				...
				<div className='grid grid-cols-3 gap-5 mx-6 my-6 max-sm:flex flex-col'>
					<div className=' border-4 bg-white border-black p-4 rounded-2xl mx-10'>
						<h3 className='text-center text-3xl mb-3'>Knowledge Checklist</h3>
						...
						<button
							className='bg-white w-60 h-16 rounded-md text-center flex justify-center items-center mx-auto mb-12 p-2  mt-3
'
						>
					...
					<div className=' border-4 bg-white border-black p-4 rounded-2xl mx-10'>
						<h3 className='text-center text-3xl mb-3'>City Mini Guide</h3>
...
'
					...
					<div className=' border-4 bg-white border-black p-4 rounded-2xl mx-10 '>
						<h3 className='text-center text-3xl mb-3'>Hotel App</h3>
						<p className='text-2xl'>
...
'
					...
					<div className='border-4  bg-white border-black p-4  rounded-2xl mx-10 '>
						<h3 className='text-center text-3xl mb-3'>Quotes App</h3>
						<p className='text-2xl'>
...
'
					...
					<div className=' border-4 bg-white border-black p-4 rounded-2xl mx-10'>
						<h3 className='text-center text-3xl mb-3'>Css challenge</h3>
						<p className='text-2xl'>
...
'
					...
					<div className=' bg-white border-4 border-black p-4 rounded-2xl mx-10'>
						...
						<button
							className=' w-60 h-16 rounded-md text-center flex justify-center items-center mx-auto mb-12 p-2
'
						>
							<a
